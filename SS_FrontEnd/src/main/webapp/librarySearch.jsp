<%@page import="ryerson.ca.frontend.helper.SongsXML"%>
    ...
    <head>
        ...
        <div style="padding-left:16px">
            ...
            <form action="FrontEnd" method="post"> 
                ...
                <table>
                    <tr><th></th><th>Title</th><th>Artist </th><th>Rating</th></tr>
                            <%  SongsXML songs = (SongsXML) request.getAttribute("songResults");
                            if(songs!=null){
                            int i=0;   
